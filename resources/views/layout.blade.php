    ...
    <section class="header-main pb-3" style="background-color: {{$interfaceColor->hd_cl_background}}">
        ...
        <img class="d-none d-md-flex" src="logo/logovn.png" width="130">
            ...
            <div class="mt-2">
                ...
                <a class="link-dm" href="/danhmuc/trang-tri-nha-cua">Trang trí nhà cửa</a>
                    <a class="link-dm" href="/danhmuc/trang-tri-quan-cafe">Trang trí quán cafe</a>
                    <a class="link-dm" href="/danhmuc/trang-tri-van-phong">Trang trí văn phòng</a>
                    <a class="link-dm" href="/danhmuc/khay-dung">Khay đựng</a>
                    <a class="link-dm" href="/danhmuc/nha-bep">Nhà Bếp</a>
                    <a class="link-dm" href="/danhmuc/tui-xach">Túi xách</a>
                    <a class="link-dm" href="/danhmuc/gio-dung">Giỏ đựng</a>
                </div>
            </div>
        </div>
    </section>
